        ...
        return this.datastore.get(currTrade.sym) //Fetch the previous quote
            ...
            if (!(data.length === 1)) {
                ...
                if (changePercentPerMinute > .009 && timeTaken >= 180) {
                    ...
                    const relativeVolume = yield this._getRelativeVolume(currTrade.sym);
                    if (relativeVolume > 2) {
    ...
    */
    _getRelativeVolume(ticker) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            lastDay.setDate(yield util_1._returnLastOpenDay(yesterday));
            ...
            return Promise.all([
                ...
                throw new exceptions_1.RequestError(`Error in ${this.constructor.name}._getRelativeVolume(): innerError: ${err} -- ${JSON.stringify(err)}`);
            });
        });
    }
}
