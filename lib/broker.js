...
exports.PhonyBroker = exports.BrokerRegistry = exports.AlpacasBroker = void 0;
//@ts-ignore
...
class AlpacasBroker extends Alpacas.AlpacaClient {
    constructor(options) {
        super({
            credentials: {
                key: options.keyId,
...
exports.AlpacasBroker = AlpacasBroker;
class BrokerRegistry {
    constructor(options) {
        this.brokers = options.brokers;
        this.logger = options.logger;
        this._dataProvider = new data_source_1.TwelveDataDataSource({
            logger: this.logger
        });
    }
    initialize() {
    ...
    isMarketTime() {
        return util_1.isMarketOpen();
    }
    getPriceByTicker(ticker) {
        return this._dataProvider.getTickerByPrice(ticker);
    }
    getAccountValue() {
        throw new exceptions_1.NotSupported(`${this.constructor.name}#getAccountValue() is not supported.
        Cannot return a value since multiple accounts are present.`);
    }
    getBuyingPower() {
        throw new exceptions_1.NotSupported(`${this.constructor.name}#getBuyingPower() is not supported.
        Cannot return a value since multiple accounts are present.`);
    }
    close() {
...
exports.PhonyBroker = PhonyBroker;
