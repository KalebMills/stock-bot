...
class ConfidenceScore {
    ...
    getConfidenceOptions(currTrade, changePercentPerMinute) {
        ...
        const volRatioScore = util_1.createDeferredPromise();
        ...
        const VWAPRatioScore = util_1.createDeferredPromise();
    ...
    getConfidenceScore(options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let processes = [];
            const allocation = Object.keys(ConfidenceScoreOptions).length;
