...
exports._returnLastOpenDay = (date) => __awaiter(void 0, void 0, void 0, function* () {
    if ((yield exports._getMarketStatusOnDate(date)) === 'CLOSED') {
        date.setDate(date.getDate() - 1);
        yield exports._returnLastOpenDay(date);
    }
    return date.getDate();
});
exports._getMarketStatusOnDate = (date) => __awaiter(void 0, void 0, void 0, function* () {
    const isWeekend = date.getDay() % 6 == 0 ? true : false;
    let holidays = yield exports._getMarketHolidays().then((data) => data.data);
