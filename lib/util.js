...
exports._minutesSinceOpen = exports._convertDate = exports._getMarketHolidays = exports._getMarketStatusOfDate = exports._returnLastOpenDay = exports.createLogger = exports.runCmd = exports.inCI = exports.createDeferredPromise = void 0;
...
exports._returnLastOpenDay = () => {
    ...
    while (true) {
        if (exports._getMarketStatusOfDate(date)) {
            return date.getDate();
        }
        date.setDate(date.getDate() - 1);
    }
};
exports._getMarketStatusOfDate = (date) => {
