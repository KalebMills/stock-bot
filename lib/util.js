...
(function (ActionSignal) {
    ActionSignal["BUY"] = "Buy";
    ActionSignal["SELL"] = "Sell";
    ActionSignal["UNKNOWN"] = "Unknown";
...
exports.isMarketTime = () => {
    return axios_2.default.get(`https://api.polygon.io/v1/marketstatus/now`, {
        ...
        throw new exceptions_1.RequestError(err.message);
    });
};
class Timer {
    constructor() {
