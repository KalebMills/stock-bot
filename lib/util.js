...
exports.getTickerSnapshot = exports.minutesSinceOpen = exports.convertDate = exports.getMarketHolidays = exports.getMarketStatusOnDate = exports.returnLastOpenDay = exports.createLogger = exports.runCmd = exports.inCI = exports.createDeferredPromise = void 0;
...
exports.returnLastOpenDay = (date) => __awaiter(void 0, void 0, void 0, function* () {
    if ((yield exports.getMarketStatusOnDate(date)) === 'CLOSED') {
        date.setDate(date.getDate() - 1);
        yield exports.returnLastOpenDay(date);
    }
    return date.getDate();
});
exports.getMarketStatusOnDate = (date) => __awaiter(void 0, void 0, void 0, function* () {
    const isWeekend = date.getDay() % 6 == 0 ? true : false;
    let holidays = yield exports.getMarketHolidays().then((data) => data.data);
...
exports.getMarketHolidays = () => {
    return axios_1.default.get('https://api.polygon.io/v1/marketstatus/upcoming', {
        ...
        .then((data) => data)
        .catch(err => {
        throw new exceptions_1.RequestError(`Error in _getMarketHolidays(): innerError: ${err} -- ${JSON.stringify(err)}`);
    });
};
...
exports.getTickerSnapshot = (ticker) => {
    return axios_2.default.get(`https://api.polygon.io/v2/snapshot/locale/us/markets/stocks/tickers/${ticker}`, {
        ...
        .then((data) => data.data)
        .catch(err => Promise.reject(new exceptions_1.RequestError(JSON.stringify(err))));
};
