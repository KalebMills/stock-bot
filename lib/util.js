...
exports.loadTickersFromFile = exports.runCmd = exports.inCI = exports.createDeferredPromise = void 0;
...
exports.loadTickersFromFile = (path) => {
    let d = [];
...
const data = exports.loadTickersFromFile(path.join(__dirname, '..', 'resources', 'tickers.txt'));
