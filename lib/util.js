...
*/
function getRelativeVolume(ticker) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        return Promise.all([
            ...
            return Promise.reject(new exceptions_1.RequestError(`Error in getRelativeVolume(): innerError: ${err} -- ${JSON.stringify(err)}`));
        });
    });
}
exports.getRelativeVolume = getRelativeVolume;
