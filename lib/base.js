    ...
    initialize() {
        return bluebird_1.default.try(() => {
            for (let i = 1; i <= this.concurrency; i++) {
                ...
                const worker = this.makeWorker(Object.assign(Object.assign({}, this.workerOptions), { metric: this.metric, id: workerId, logger: this.logger, _preProcessor: this.preProcess }));
