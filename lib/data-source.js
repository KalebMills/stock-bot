...
exports.PhonyDataSource = exports.TwitterDataSource = exports.TwitterAccountType = exports.PolygonLiveDataSource = exports.PolygonGainersLosersDataSource = exports.YahooGainersDataSource = exports.DataSource = void 0;
...
(function (TwitterAccountType) {
    TwitterAccountType[TwitterAccountType["LONG_POSITION"] = 0] = "LONG_POSITION";
    TwitterAccountType[TwitterAccountType["FAST_POSITION"] = 1] = "FAST_POSITION";
    TwitterAccountType[TwitterAccountType["OPTIONS_POSITION"] = 2] = "OPTIONS_POSITION";
...
class TwitterDataSource extends DataSource {
    ...
    _processTweet(tweet) {
        ...
        const hasTicker = ticker.length > 0 && this.tickerList.includes(ticker[0].toUpperCase());
        if (hasTicker) {
