...
exports.PolygonLiveDataSource = exports.PolygonGainersLosersDataSource = exports.YahooGainersDataSource = exports.DataSource = void 0;
...
class PolygonLiveDataSource extends DataSource {
        ...
        this._statusHandler = (data) => {
            switch (data.status) {
                case 'connected':
                    ...
                    this.logger.log(base_1.LogLevel.INFO, `Connected to ${this.scrapeUrl}`);
                    break;
                case 'auth_success':
    ...
    scrapeDatasource() {
        ...
        this.logger.log(base_1.LogLevel.INFO, `${this.constructor.name}#data has ${Object.keys(outputData).length} values in it`);
        this.logger.log(base_1.LogLevel.INFO, `outputData has ${Object.keys(outputData).length} values in it`);
