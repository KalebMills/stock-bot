...
exports.PolygonGainersDataSource = exports.YahooGainersDataSource = exports.DataSource = void 0;
...
class PolygonGainersDataSource extends DataSource {
    constructor(options) {
        super(options);
    }
    scrapeDatasource() {
        return axios_1.default.all([axios_1.default.get(this.scrapeUrl + 'gainers'), axios_1.default.get(this.scrapeUrl + 'losers')])
            .then(axios_1.default.spread((gainers, losers) => {
            ...
            try {
                data.forEach(response => {
                    for (let snapshot of response.data['tickers']) {
                        ...
                        this.logger.log(base_1.LogLevel.TRACE, `Ticker Scape: ${stockObj.ticker} -- Price: ${stockObj.price} -- Change: ${stockObj.percentChange}`);
                    }
                });
            }
            catch (err) {
...
exports.PolygonGainersDataSource = PolygonGainersDataSource;
