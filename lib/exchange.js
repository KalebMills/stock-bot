...
class AlpacasExchange extends Alpacas.Client {
    constructor(options) {
        ...
        if (options.testing) {
            this.logger.log(base_1.LogLevel.INFO, chalk_1.default.bgYellowBright.blackBright(`${this.constructor.name}#constructor - In PAPER mode, no real trades will be executed.`));
        }
    }
