...
class StockService extends base_1.Service {
    ...
    makeWorker(options) {
        return new this.mainWorker(Object.assign(Object.assign({}, options), { _preProcessor: this.preProcess, exceptionHandler: this.exceptionHandler, purchaseOptions: this.purchaseOptions, broker: this.broker, notification: this.notification, dataSource: this.datasource, dataStore: this.datastore, metric: this.metric, accountPercent: this.accountPercent }));
    }
    close() {
