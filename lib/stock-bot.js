    ...
    constructor(options) {
        ...
        */
        this.preProcess = () => __awaiter(this, void 0, void 0, function* () {
            ...
            if (!marketIsOpen) {
                this.logger.log(base_1.LogLevel.WARN, 'Market is currently closed. Delaying next try by 5 minutes.');
                ...
                return this.fetchWork()
                    ...
                    if (!(this.processables.length > 0)) {
                        ...
                        if (this.processables.some((ticker) => !keys.includes(ticker.ticker))) {
                            ...
                            this.logger.log(base_1.LogLevel.WARN, `this.processables.length = 0, return the backoff promise`);
                            return bluebird_1.default.delay(5000).then(() => this.preProcess());
                        }
                    }
                    else {
                        this.logger.log(base_1.LogLevel.WARN, `Nothing in this.processables, instead retrying this.preProcess()`);
