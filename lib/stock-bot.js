...
class StockService extends base_1.Service {
    ...
    makeWorker(options) {
        return new StockServiceWorker(Object.assign(Object.assign({}, options), { exceptionHandler: this.exceptionHandler, postTransaction: this.postTransaction, purchaseOptions: this.purchaseOptions, exchange: this.exchange, notification: this.notification }));
    }
    close() {
