        ...
        */
        this.preProcess = () => __awaiter(this, void 0, void 0, function* () {
            ...
            if (this.processables.length > 0) {
                ...
                this.logger.log(base_1.LogLevel.TRACE, `Taking ${JSON.stringify(ticker)} out of this.processables, pushing ticker to this.process(${JSON.stringify(ticker)})`);
                ...
                this.logger.log(base_1.LogLevel.INFO, `this.processables.length = ${this.processables.length}`);
