...
class StockService extends base_1.Service {
    ...
    makeWorker(options) {
        return new this.mainWorker(Object.assign(Object.assign({}, options), { exceptionHandler: this.exceptionHandler, purchaseOptions: this.purchaseOptions, exchange: this.exchange, notification: this.notification }));
    }
    close() {
